...
int identify_command_and_atributes(char* string, Array** my_array) {
    ...
    switch (f)
    {
        ...
        printf("Case Load\n");
            ...
            reply = command_load(first_atrib, sec_atrib, my_array);
            // printf("shokk load\n");
            break;
        ...
        case 'S':
            switch (s)
            {
                case 'a':
                    ...
                    reply = command_save(first_atrib, sec_atrib, my_array);
                    break;
                ...
                case 'o':
                    ...
                    first_atrib[1] = '\0';
                    mark = 1 ? string[6] == '+' : 0;
                    reply = command_sort(first_atrib, mark, my_array);
                    break;
                ...
                case 'h':
                    ...
                    reply = command_shuffle(first_atrib, my_array);
                ...
                default:
                    ...
                    reply = command_stats(first_atrib, my_array);
                    break;
            }
        ...
        case 'R':
            if (s == 'a') {
                ...
                reply = command_rand(first_atrib, sec_atrib, thir_atrib, fourth_atrib, my_array);
                ...
                first_atrib[1] = '\0';
                reply = command_remove(first_atrib, sec_atrib, thir_atrib, my_array);
                // printf("shokk remove\n");
            }
            break;
        ...
        case 'C':
            if (t == 'n') {
                ...
                sec_atrib[1] = '\0';
                reply = comand_concat(first_atrib, sec_atrib, my_array);
            } else {
                printf("Case Copy\n");
                char* garbage = strtok(string, separator);
                sec_atrib = strtok(NULL, separator);
                ...
                fourth_atrib[1] = '\0';
                reply = command_copy(first_atrib, sec_atrib, thir_atrib, fourth_atrib, my_array);
                // printf("shokk copy\n\n");
            }
            break;
        ...
        case 'F':
            ...
            first_atrib[0] = toupper(string[5]);
            first_atrib[1] = '\0';
            reply = command_free(first_atrib, my_array);
            break;
        ...
        default:
            ...
            if (w == 13) {
                ...
                first_atrib[1] = '\0';
                reply = command_print_all(first_atrib, my_array);
                // printf("shokk print\n\n");
            } else {
                ...
                first_atrib[0] = toupper(string[6]);
                first_atrib[1] = '\0';
                reply = command_print_range(first_atrib, sec_atrib, thir_atrib, my_array);
            }
            break;
    }
}
...
int analize_command_file(FILE *f1) {
    ...
    char* my_string;
    Array* hello = (Array*)malloc(sizeof(Array) * 26);
    for (int i = 0; i < 26; i++) {
        hello[i].size = 0;
    }
    while (x != end_of_file) {
        ...
        // printf("%s\n", my_string);
        if (x != end_of_file) {
            reply = identify_command_and_atributes(my_string, &hello);
